...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__add-lot button" <?= ($is_auth == 1) ? "href='add.php'":""?>>Добавить лот</a>
...
<main>
    <nav class="nav">
      ...
      <?php foreach($categorys as $category):?>
        <li class="nav__item">
          <a href="all-lots.html"><?=htmlspecialchars($category['category'])?></a>
        </li>
        <?php endforeach;?>
      </ul>
    </nav>
...
<footer class="main-footer">
    ...
    <div class="main-footer__bottom container">
        ...
        <a class="main-footer__add-lot button" <?= ($is_auth == 1) ? "href='add.php'":""?>>Добавить лот</a>
